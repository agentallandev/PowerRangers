...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphSlayerProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRSlayerMorpherItem extends Item {
	public MMPRSlayerMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphSlayerProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
