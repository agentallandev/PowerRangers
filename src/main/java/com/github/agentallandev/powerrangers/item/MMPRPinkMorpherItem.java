...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphPinkProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRPinkMorpherItem extends Item {
	public MMPRPinkMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphPinkProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
