...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphDrakkonProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRDrakkonMorpherItem extends Item {
	public MMPRDrakkonMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphDrakkonProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
