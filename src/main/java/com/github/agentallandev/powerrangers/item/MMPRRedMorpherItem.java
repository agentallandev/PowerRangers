...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphRedProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRRedMorpherItem extends Item {
	public MMPRRedMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphRedProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
