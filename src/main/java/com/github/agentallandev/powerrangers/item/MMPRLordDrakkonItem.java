...
public abstract class MMPRLordDrakkonItem extends ArmorItem {
	...
	public static class Helmet extends MMPRLordDrakkonItem {
		public Helmet() {
	...
	public static class Chestplate extends MMPRLordDrakkonItem {
		public Chestplate() {
	...
	public static class Leggings extends MMPRLordDrakkonItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "powerrangers:textures/models/armor/drakkon__layer_2.png";
		}
	}

	public static class Boots extends MMPRLordDrakkonItem {
		public Boots() {
