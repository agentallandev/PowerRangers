...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphWhiteProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRWhiteMorhperItem extends Item {
	public MMPRWhiteMorhperItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphWhiteProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
