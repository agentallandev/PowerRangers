...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphGreenProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRGreenMorpherItem extends Item {
	public MMPRGreenMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphGreenProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
