...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphBlackProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRBlackMorpherItem extends Item {
	public MMPRBlackMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphBlackProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
