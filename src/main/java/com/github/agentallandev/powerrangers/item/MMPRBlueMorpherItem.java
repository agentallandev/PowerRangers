...
import com.github.agentallandev.powerrangers.procedures.MMPRMorphBlueProcedure;
import com.github.agentallandev.powerrangers.init.PowerrangersModTabs;

public class MMPRBlueMorpherItem extends Item {
	public MMPRBlueMorpherItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MMPRMorphBlueProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
